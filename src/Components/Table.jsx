    ...
    <div className=" w-full">
      <table className="w-full text-[14px]   font-galano leading-[20px]  text-['#1a181e]">
        <thead className="bg-[#f2f2f2] text-[14px] font-galano leading-[20px] font text-['#1a181e] text-left  ">
          <tr>
            <th className="py-[10px] px-[12px]  text-[#4d4d4d] rounded-l-[4px]  w-80">
             Order ID
            </th>
            <th className="py-[10px] px-[12px]  text-[#4d4d4d] w-80 ">
            Status
            </th>
          ...
          {data.map((item, index) => (
            <>
              ...
              >
                ...
                <td className="py-[14px] px-[12px] flex items-center gap-[8px] text-[#1a181e]  w-80">
                  <div
